...
<body>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">Links<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="employee.php" onclick="openPage()">Employee</a> </li>
						</ul>
					</li>
				</ul>
			</div>
	...
	<section>
			...
			<div class="row">
				...
				<form id="form1" name="form1" method="post">
					<div class="text-center">
						<div class="checkbox">
							<label><input type="checkbox" value="">Remove</label> &nbsp &nbsp &nbsp
					...
					<div>
						...
						<div class="input-group"><span class="input-group-addon">Recipe</span>
							<textarea class="form-control" rows="2" id="steps" placeholder="Steps"></textarea>
						</div>
					</div>
					&nbsp
					<div class="text-center">
      ...
      <label>Tea Leaves or Cofee Beans</label>
      </span>
						...
						<div class="input-group input-group-sm"><span class="input-group-addon">Import Location</span>
							<input type="text" class="form-control" placeholder="Only for Tea Leaves / Coffee Beans">
						</div>
						&nbsp
						<div class="text-center">
							<button type="button" class="btn btn-primary">Submit</button>
  	...
  	<label>Condiments</label></span>
						...
						<div class="input-group input-group-sm"><span class="input-group-addon">Best Before</span>
							<input type="date" class="form-control" style="color: #999999">
						</div>
						&nbsp
						<div class="text-center">
							<button type="button" class="btn btn-primary">Submit</button>
